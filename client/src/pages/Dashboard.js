...
=======
                ...
                <ListItem>
                  <ListItemButton onClick={() => handleItemClick('connect')}
                    sx={{
                    color: selectedItem === 'connect' ? '#2ACAEA' : '#009DFF', 
                    border: selectedItem === 'connect' ? 'solid' : '',
                    borderRadius: selectedItem === 'connect' ? "10px" : '', 
                    borderColor: selectedItem === 'connect' ? '#006EB3' : '',
                  }}>
                    <ListItemDecorator>
                      <ViewCompactAltIcon/>
>>>>>>> e38d94566fcf630765175fa4829a1dc82bf3fe0f
                    </ListItemDecorator>
                    <ListItemContent 
                    selected={selectedItem === 'connect'}
                    onClick={handleShowConnect}
                ...
                <ListItem>
                  <ListItemButton onClick={() => handleItemClick('aboutus')}
                    sx={{
                      color: selectedItem === 'aboutus' ? '#2ACAEA' : '#009DFF', 
                      border: selectedItem === 'aboutus' ? 'solid' : '',
                      borderRadius: selectedItem === 'aboutus' ? "10px" : '', 
                      borderColor: selectedItem === 'aboutus' ? '#006EB3' : '',
                    }}>
                    <ListItemDecorator sx={{ color: 'neutral.500' }}>
                      <PersonIcon/>
                    </ListItemDecorator>
                ...
                <ListItem>
                  <ListItemButton onClick={() => handleItemClick('contact')}
                    sx={{
                    color: selectedItem === 'contact' ? '#2ACAEA' : '#009DFF', 
                    border: selectedItem === 'contact' ? 'solid' : '',
                    borderRadius: selectedItem === 'contact' ? "10px" : '', 
                    borderColor: selectedItem === 'contact' ? '#006EB3' : '',
                    }}>
                    <ListItemDecorator sx={{ color: 'neutral.500' }}>
                      <ContactSupportIcon/>
                      </ListItemDecorator>
          ...
          >
            <div key={postAndCommentsData.post._id}>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px' }}>
                  <Avatar src={postAndCommentsData.me.image} size="lg" sx={{ '--Avatar-size': '50px', border: 'solid', borderColor: '#2ACAEA'}} />
              </Box>
                <Typography sx={{ flex: 1, color: '#2ACAEA', fontFamily: 'monospace', }}>
            ...
            >
            <Typography variant='body2' sx={{ fontSize: '12px', padding: '15px', fontFamily: 'monospace',  }}>Posted: {new Date(parseInt(postAndCommentsData.post.createdAt)).toLocaleDateString()}</Typography>
              <Box
                sx={{
                  gap: 2,
                  p: 2,
            ...
            {postAndCommentsData.post.comments?.length === 0 ? (
                ...
                <>
                  {postAndCommentsData.post.comments.map((comment) => (
                    <div key={comment._id} style={{ display: 'flex', justifyContent: 'space-between', padding: '10px', border: 'solid', borderRadius: '10px', borderColor: '#2ACAEA',  width: '80%', margin: 'auto', marginTop: '15px'}}>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px',  }}>
                        <Avatar src={postAndCommentsData.me.image} size="lg" sx={{ '--Avatar-size': '35px', border: 'solid', borderColor: '#2ACAEA'}} />
                      </Box>
                      ...
                      <IconButton variant="outlined" color='danger' sx={{ padding: '2px', height: '10px', border: 'none' }} onClick={() => handleDeleteComment(postAndCommentsData.post._id, comment._id)}>
                        <DeleteIcon/> 
                      </IconButton>
                    </div>
                  ))}
